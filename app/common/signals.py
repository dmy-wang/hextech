...
class SignalBus(QObject):
    ...
    # BP Assistant:
    bpRecommendationUpdated = pyqtSignal(dict)  # BP 推荐更新
    bpPhaseChanged = pyqtSignal(str)            # BP 阶段变化
    preGameAnalysisReady = pyqtSignal(dict)     # 赛前分析就绪
    teamAnalysisReady = pyqtSignal(dict)        # 阵容分析就绪
